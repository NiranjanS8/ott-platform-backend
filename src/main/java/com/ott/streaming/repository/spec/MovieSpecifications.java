...
public final class MovieSpecifications {
    ...
    public static Specification<Movie> forCatalog(String search, CatalogFilterInput filter) {
    ...
    private static Specification<Movie> titleContains(String search) {
    ...
    private static Specification<Movie> hasAccessLevel(CatalogFilterInput filter) {
    ...
    private static Specification<Movie> releasedInYear(CatalogFilterInput filter) {
    ...
    private static Specification<Movie> hasLanguage(CatalogFilterInput filter) {
    ...
    private static Specification<Movie> hasGenre(CatalogFilterInput filter) {
